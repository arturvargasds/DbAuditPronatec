                            ...
                            <div class="tab-pane fade" id="settings-pills">  
                                 <form id="addForm" method="POST" action="Exemplo.jsp" class="form-group">  
                                     <div class=" container-fluid " > <br>
                                       ...
                                       -->     
                                            <div class="col-lg-offset-0">
                                                <div class="col-lg-12">  <label>ID</label>      <input class="form-control" readonly="true" placeholder="ID"></div>
                                                <div class="col-lg-3">   <label>NOME</label>    <input class="form-control" placeholder="NOME"></div>   
                                                <div class="col-lg-9">   <label>FONE</label>    <input class="form-control" placeholder="FONE"></div>
                                                <div class="col-lg-9">   <label>FONE 2</label>  <input class="form-control" placeholder="FONE 2"></div>
                                                <div class="col-lg-9">   <label>EMAIL</label>   <input TYPE="email" class="form-control" placeholder="EMAIL"></div>
                                                <div class="col-lg-9">   <label>FONE</label>    <input class="form-control" placeholder="FONE"></div>
                                            <br><br>
