	...
	<h4>Auditando  CheckPoint: <b style="color: red;font-size: 23px;">{{checklist.idpontoctrl}}</b> </h4>   
	 ...
	 <form name="checkForm">	<!--formulario-->
          ...
          <div class="panel panel-green">
           <div class="panel-heading">
             ...
             <div class="panel-body"> 
                 <div class="col-lg-4">  <label>Auditoria</label>  <input class="form-control"  type="number" ng-model="checklist.idaudit.idaudit " name="audit" placeholder="Codigo da Auditoria"  ng-required="true"/> <br></div> 
        ...
        <!--************************************************  Validadção dos campos *****************************************-->
                        ...
                        <div class="panel-body">
                           <div class="panel-collapse">
                               <div  class="col-lg-12"><label>N° do Documento do Processo</label>  <input class="form-control"  type="number" ng-model="checklist.docprocesso" name="docP"  placeholder="N° do Documento.... " ng-required="true" ng-minlength="1" ng-maxlength="12"/></div>
                      <!--******************* *********  Validadção dos campos *****************************************-->
         ...
         <div class="col-lg-12"> <!--** *************** Equipe de Auditores-->
          <div class="panel panel-green">
           <div class="panel-heading">
             ...
             <div class="panel-body">
                 <div class="col-lg-4">  <label>Equipe</label>  <input class="form-control"  type="number" ng-model="checklist.idequipe.idequipe" name="equA" placeholder="Codigo Equipe de Auditores" ng-required="true"/> <br></div> 
           ...
           <div class="row"> <p> 
              ...
              <div class="col-md-6"> 
                    <div class="panel panel-green">
                        ...
                        <div class="panel-body">
                           <div class="col-lg-3">  <label>Codigo</label>    <input class="form-control"    type="number" ng-model="checklist.idcola.idcola   " name="certi" placeholder="Codigo Colaborador"  ng-required="true" disabled=""/> </div>
                           <div class="col-lg-9">  <label>Nome </label>    <input class="form-control"    type="text" ng-model="checklist.idcola.nomecola " name="certi" placeholder="Nome"  ng-required="true" disabled="" /> </div>
