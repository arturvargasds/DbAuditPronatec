...
angular.module("app").controller("listChecklistsCtrl", function ($scope, checklists,$location,checklistsAPI) {
	...
	$scope.deleteChecklist = function (checklists) {	
		checklistsAPI.getChecklists(checklists).success(function (data) {
