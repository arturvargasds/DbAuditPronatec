...
<html>
    ...
    <body>
     ...
     <table width="561" border="1" align="center">
      <tr bgcolor="#FFFF00">
        <td width="58"><div align="center" class="style4">C&oacute;digo</div></td>
        <td width="147"><div align="center" class="style4">Nome do Usu&aacute;rio</div></td>
        <td width="77"><div align="center" class="style4">Senha</div></td>
        <td width="104"><div align="center" class="style4">N&iacute;vel </div></td>
      ...
      <tr bgcolor="#CCFFCC">
        <td><div align="center"><%=rs.getString("log_codigo")%></div></td>
        <td><%=rs.getString("log_usuario")%></td>
        <td><div align="center"><%=rs.getString("log_senha")%></div></td>
        <td><div align="center"><%=rs.getString("log_nivelacesso")%></div></td>
        <td><div align="center"><a  href="alteraUsuario.jsp?codigo=<%=rs.getString("log_codigo")%>&amp;usuario=<%=rs.getString("log_usuario")%>&amp;senha=<%=rs.getString("log_senha")%>&amp;nivelacesso=<%=rs.getString("log_nivelacesso")%>&amp;codexc=<%=rs.getString("log_codigo")%>"><img src="imagens/alterar.png" width="24" height="24" /></a>
            </div>
         </td>
